...
# ----------------------------------------------------
# 5. HANDOFF TO OTHER PAGES
# ----------------------------------------------------
# Streamlit's session_state persists across pages in a multi-page app,
# so this is how the Itinerary/Map page and the Chatbot page get access
# to everything computed here, without the tourist re-entering anything.
st.session_state["trip_context"] = hotel_payload

if destinations:
    st.success("✅ Trip data saved. Head to the **Itinerary & Map** page in the sidebar to continue.")
else:
    st.info("Select at least one destination above, then continue to the **Itinerary & Map** page.")
